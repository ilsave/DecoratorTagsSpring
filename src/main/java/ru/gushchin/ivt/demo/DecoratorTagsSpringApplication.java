...
public class DecoratorTagsSpringApplication {

    public static void main(String[] args) {
        SpringApplication.run(DecoratorTagsSpringApplication.class, args);
    ...
    static void PrintInFile(List<String> list, File file){
        ...
        try {
            ...
            for (String line1 : list){
                ...
                System.out.println(returnInt.sendBackLine(line1));
